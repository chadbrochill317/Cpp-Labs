 ...
 */
void newpart (vector <Part> & parts){
  Part temp;
...
int main(){
   ...
   int n = 10;
   vector <Part> parts; //a dynamicaly allocated array of structures
   //int size = 0;
   int choice;
   do {
     choice = menu();
     switch (choice){
       case 1: newpart (parts); break;
       case 2: {int pos = find (parts);
...
// vector get rid of array and use .size
